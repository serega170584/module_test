...
$iblockCode = "as_slider_".WIZARD_SITE_ID; 
...
//Form settings
$res_idassliderfile = CIBlockProperty::GetByID("AS_SLIDER_FILE", false, $iblockCode);
$ar_res_idassliderfile = $res_idassliderfile->GetNext();
$idassliderfile = $ar_res_idassliderfile['ID'];
$res_idassliderlink = CIBlockProperty::GetByID("AS_SLIDER_LINK", false, $iblockCode);
$ar_res_idassliderlink = $res_idassliderlink->GetNext();
$idassliderlink = $ar_res_idassliderlink['ID'];

      $arFormSettings = array(
         array(
            array("edit1", GetMessage("SLAID")),
			array("NAME", GetMessage("NAZVANIE")),
			array("PROPERTY_".$idassliderfile, GetMessage("IZOBR")),
			array("PROPERTY_".$idassliderlink, GetMessage("SSULKA")),
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir."/header.php", array("SLIDER_CODE" => $iblockCode));
?>

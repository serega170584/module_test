...
if(CModule::IncludeModule("iblock")) :
	$dbElement = CIBlockElement::GetList(Array('SORT' => 'ASC', 'TIMESTAMP_X' => 'DESC'), Array('IBLOCK_CODE' => $arParams['IBLOCK_CODE'], 'ACTIVE' => 'Y', 'ACTIVE_DATE'=>'Y'), false, Array("nPageSize"=>100, "iNumPage"=>1), Array('ID', 'IBLOCK_ID', 'NAME', 'CODE', 'DATE_ACTIVE_FROM', 'DETAIL_PAGE_URL', 'IBLOCK_TYPE_ID', 'IBLOCK_SECTION_ID', 'PROPERTY_'.$arParams['PROP'], 'PROPERTY_'.$arParams['LINK']));
		$n=1;
		...
		$img = CFile::ResizeImageGet($arElement['PROPERTY_'.$arParams['PROP'].'_VALUE'], Array('width' => 1200, 'height' => 300), BX_RESIZE_IMAGE_EXACT, true);
		 $arResult['ITEMS'][$n]['IMG'] = $img['src'];
		 
		 $arResult['ITEMS'][$n]['LINK'] = $arElement['PROPERTY_'.$arParams['LINK'].'_VALUE'];

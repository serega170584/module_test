...
$iblockCode = "as_goods_".WIZARD_SITE_ID; 
$iblockType = "as_catalog_".WIZARD_SITE_ID; 
...
//Column settings
$arColumns = array("NAME", "DETAIL_PICTURE", "ACTIVE", "SORT", "TIMESTAMP_X", "USER_NAME");
$arListFields = array(
...
//Form settings
      $arFormSettings = array(
         array(
            array("edit1", GetMessage("TOVAR")),
			array("NAME", GetMessage("NAZVANIE")),
            array("CODE", GetMessage("SIMVKOD")),
			array("SORT", GetMessage("SORTIROVKA")),
			array("IBLOCK_ELEMENT_PROP_VALUE", GetMessage("AKTIVNOSTGR")),
            array("ACTIVE", GetMessage("AKTIVNOST")),
			array("ACTIVE_FROM", GetMessage("NACHACT")),
         ...
         array(
			...
			array("DETAIL_PICTURE", GetMessage("DETALNKART")),
            array("DETAIL_TEXT", GetMessage("DETALNOPIS")),
         ),
         array(
            array("edit4", "SEO"), 
		 ...
		 array(
            array("edit5", GetMessage("RAZDELU")),
            array("SECTIONS", GetMessage("RAZDELU")),
         ),
      );
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_IBLOCK_TYPE" => $iblockType));
?>
